...
internal class VivoxCoreInstance {
  ...
  public static int vx_req_account_get_conversations_create(SWIGTYPE_p_p_vx_req_account_get_conversations req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_get_conversations_create(SWIGTYPE_p_p_vx_req_account_get_conversations.getCPtr(req));
    return ret;
  }

  public static int vx_req_account_chat_history_set_marker_create(SWIGTYPE_p_p_vx_req_account_chat_history_set_marker req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_chat_history_set_marker_create(SWIGTYPE_p_p_vx_req_account_chat_history_set_marker.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_account_safe_voice_update_consent_create(SWIGTYPE_p_p_vx_req_account_safe_voice_update_consent req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_safe_voice_update_consent_create(SWIGTYPE_p_p_vx_req_account_safe_voice_update_consent.getCPtr(req));
    return ret;
  }

  public static int vx_req_account_safe_voice_get_consent_create(SWIGTYPE_p_p_vx_req_account_safe_voice_get_consent req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_safe_voice_get_consent_create(SWIGTYPE_p_p_vx_req_account_safe_voice_get_consent.getCPtr(req));
    return ret;
  }
  ...
  public static int vxunity_unregister_all_taps() {
    int ret = VivoxCoreInstancePINVOKE.vxunity_unregister_all_taps();
    return ret;
  }

  public static int vxunity_unregister_tap(int tapId) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_unregister_tap(tapId);
    return ret;
  }

  public static int vxunity_register_for_channel_audio(uint bufferDuration, string channelUri) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_register_for_channel_audio(bufferDuration, channelUri);
    return ret;
  }

  public static int vxunity_get_channel_audio_for_id(int tapId, float[] data, int numFrames, int numChannels, int sampleRate) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_get_channel_audio_for_id(tapId, data, numFrames, numChannels, sampleRate);
    return ret;
  }

  public static int vxunity_register_for_capture_source(uint bufferDuration, string channelUri) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_register_for_capture_source(bufferDuration, channelUri);
    return ret;
  }

  public static int vxunity_get_capture_audio_for_id(int tapId, float[] data, int numFrames, int numChannels, int sampleRate) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_get_capture_audio_for_id(tapId, data, numFrames, numChannels, sampleRate);
    return ret;
  }

  public static int vxunity_register_for_capture_sink(uint bufferDuration, string channelUri) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_register_for_capture_sink(bufferDuration, channelUri);
    return ret;
  }

  public static int vxunity_put_capture_audio_for_id(int tapId, float[] data, int numFrames, int numChannels, int sampleRate) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_put_capture_audio_for_id(tapId, data, numFrames, numChannels, sampleRate);
    return ret;
  }

  public static int vxunity_register_for_participant_audio(uint bufferDuration, string participantUri, string channelUri, bool silenceInFinalMix) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_register_for_participant_audio(bufferDuration, participantUri, channelUri, silenceInFinalMix);
    return ret;
  }

  public static int vxunity_get_participant_audio_for_id(int tapId, float[] data, int numFrames, int numChannels, int sampleRate) {
    int ret = VivoxCoreInstancePINVOKE.vxunity_get_participant_audio_for_id(tapId, data, numFrames, numChannels, sampleRate);
    return ret;
  }

  public static void send_all_logs() {
    VivoxCoreInstancePINVOKE.send_all_logs();
  }
  ...
  public static int vx_conversation_create(SWIGTYPE_p_p_vx_conversation conversation) {
    int ret = VivoxCoreInstancePINVOKE.vx_conversation_create(SWIGTYPE_p_p_vx_conversation.getCPtr(conversation));
    return ret;
  }

  public static int vx_conversation_free(vx_conversation_t conversation) {
    int ret = VivoxCoreInstancePINVOKE.vx_conversation_free(vx_conversation_t.getCPtr(conversation));
    return ret;
  }

  public static int vx_conversation_list_create(int size, SWIGTYPE_p_p_p_vx_conversation list_out) {
    int ret = VivoxCoreInstancePINVOKE.vx_conversation_list_create(size, SWIGTYPE_p_p_p_vx_conversation.getCPtr(list_out));
    return ret;
  }

  public static int vx_conversation_list_free(int size, SWIGTYPE_p_p_vx_conversation list) {
    int ret = VivoxCoreInstancePINVOKE.vx_conversation_list_free(size, SWIGTYPE_p_p_vx_conversation.getCPtr(list));
    return ret;
  }
  ...
  public static int vx_get_ios_voice_processing_io_mode(out int mode) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_ios_voice_processing_io_mode(out mode);
    return ret;
  }

  public static int vx_set_ios_voice_processing_io_mode(int mode) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_ios_voice_processing_io_mode(mode);
    return ret;
  }
  ...
  public static int vx_get_noise_suppression_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_noise_suppression_enabled(out enabled);
    return ret;
  }

  public static int vx_get_noise_suppression_level(SWIGTYPE_p_vx_noise_suppression_level level) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_noise_suppression_level(SWIGTYPE_p_vx_noise_suppression_level.getCPtr(level));
    return ret;
  }

  public static int vx_set_noise_suppression_enabled(int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_noise_suppression_enabled(enabled);
    return ret;
  }

  public static int vx_set_noise_suppression_level(vx_noise_suppression_level level) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_noise_suppression_level((int)level);
    return ret;
  }
  ...
  public static int vx_set_volume_based_duplication_suppression_enabled(int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_volume_based_duplication_suppression_enabled(enabled);
    return ret;
  }

  public static int vx_get_volume_based_duplication_suppression_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_volume_based_duplication_suppression_enabled(out enabled);
    return ret;
  }

  public static int vx_set_3d_channel_volume_protection_enabled(int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_3d_channel_volume_protection_enabled(enabled);
    return ret;
  }

  public static int vx_get_3d_channel_volume_protection_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_3d_channel_volume_protection_enabled(out enabled);
    return ret;
  }

  public static int vx_set_audio_clipping_protector_enabled(int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_audio_clipping_protector_enabled(enabled);
    return ret;
  }

  public static int vx_get_audio_clipping_protector_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_audio_clipping_protector_enabled(out enabled);
    return ret;
  }

  public static int vx_set_audio_clipping_protector_parameters(float minimum_threshold_db, float threshold_boost_slope) {
    int ret = VivoxCoreInstancePINVOKE.vx_set_audio_clipping_protector_parameters(minimum_threshold_db, threshold_boost_slope);
    return ret;
  }

  public static int vx_get_audio_clipping_protector_parameters(out float minimum_threshold_db, out float threshold_boost_slope) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_audio_clipping_protector_parameters(out minimum_threshold_db, out threshold_boost_slope);
    return ret;
  }
  ...
  public static readonly int VxErrorFailed = VivoxCoreInstancePINVOKE.VxErrorFailed_get();
  ...
  public static readonly int VxSafeVoiceConsentUnauthorized = VivoxCoreInstancePINVOKE.VxSafeVoiceConsentUnauthorized_get();
  public static readonly int VxSafeVoiceConsentInvalidProjectOrEnvironment = VivoxCoreInstancePINVOKE.VxSafeVoiceConsentInvalidProjectOrEnvironment_get();
  public static readonly int VxSafeVoiceInternalError = VivoxCoreInstancePINVOKE.VxSafeVoiceInternalError_get();
  public static readonly int VxSafeVoiceConsentNotSet = VivoxCoreInstancePINVOKE.VxSafeVoiceConsentNotSet_get();
  public static readonly int VxSafeVoiceUnknownError = VivoxCoreInstancePINVOKE.VxSafeVoiceUnknownError_get();
  public static readonly int VxErrorJobDependencyFailed = VivoxCoreInstancePINVOKE.VxErrorJobDependencyFailed_get();
  ...
  public static readonly int VxXmppErrorChannelAtCapacity = VivoxCoreInstancePINVOKE.VxXmppErrorChannelAtCapacity_get();
